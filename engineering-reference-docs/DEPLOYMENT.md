# Deployment Guide: n8n-nodes-sinch
...
cd /path/to/connectors/n8n/n8n-build/n8n-nodes-sinch
...
4. 📤 Publishes to `@sinch-engage/n8n-nodes-sinch@alpha`
...
- Name: `@sinch-engage/n8n-nodes-sinch` (organization scope)
...
npm view @sinch-engage/n8n-nodes-sinch versions --json

# View package info
npm view @sinch-engage/n8n-nodes-sinch
```
...
npm install @sinch-engage/n8n-nodes-sinch@alpha

# Or install in n8n for testing
# In n8n: Settings → Community Nodes → Install
# Enter: @sinch-engage/n8n-nodes-sinch
```
...
- Verify alpha tag: `npm view @sinch-engage/n8n-nodes-sinch dist-tags`

### Getting Help
- Check NPM status: https://status.npmjs.org/
- NPM support: https://www.npmjs.com/support
- Package: https://www.npmjs.com/package/@sinch-engage/n8n-nodes-sinch
...
npm unpublish @sinch-engage/n8n-nodes-sinch@1.0.0-alpha-0
```
...
**Current Status**: `@sinch-engage/n8n-nodes-sinch@1.0.0-alpha-0` - Ready for development testing

**Next Phase**: Production deployment to `@sinch-engage/n8n-nodes-sinch@1.0.0`
